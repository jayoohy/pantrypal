...
const TrendingPostsPreview: FC<TrendingPostsPreviewProps> = ({
  ...
  return (
    <div className="mt-20 md:mt-35 mx-6 md:mx-30 xl:mx-56 flex justify-center items-center flex-col">
      <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-normal text-center mb-2 lg:mb-6">
        Trending Recipes
      </h1>
      <p
        className={cn(
          "text-center text-gray-600 dark:text-white md:mx-30 lg:mx-20 xl:mx-60",
          "mb-10 lg:mb-12 text-[0.7rem] lg:text-[1rem]"
        )}
      >
        Are you really into cooking? These homemade meal recipes will totally
        blow the minds of your family members.
      </p>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 lg:gap-4 lg:pt-3">
        <div className="relative col-span-2">
          ...
          <div
            className={cn(
              "bg-black/10 hover:bg-black/30 backdrop-brightness-50 absolute inset-0",
          ...
          >
            <div className="flex justify-center flex-col items-center">
              ...
              >
                <p
                  className={cn(
                    "bg-orange-50 dark:bg-gray-800 text-red-500 hover:text-red-700",
                    "rounded-md p-2 w-fit text-[0.6rem] lg:text-[1rem]"
                  )}
                >
                  {recipe1.strCategory}
                </p>
              ...
              <Link key={recipe1.idMeal} to={`/recipe/${recipe1.idMeal}`}>
                <h1 className="text-2xl lg:text-4xl py-4 hover:text-gray-200">
                  {recipe1.strMeal}
                </h1>
              </Link>
              <div className="flex text-[0.75rem] lg:text-[0.9rem]">
      ...
      <Link
        to={"/t-posts"}
        className="bg-red-500 hover:bg-red-400 p-3 lg:p-5 text-white rounded-sm mt-8"
      >
